...
class ReporterTests(unittest.TestCase):
    def test_render_report_contains_required_sections(self):
        selected = {
            CATEGORY_AI: [
                Article(
                    ...
                    "CNBC",
                    3.0,
                    published_at=datetime(2026, 1, 1, 15, 30, tzinfo=timezone.utc),
                )
            ],
            CATEGORY_FINANCE: [],
            CATEGORY_OTHER: [],
        ...
        self.assertIn("Published: 2026-01-01 15:30 UTC", report)
    ...
    def test_render_html_report_contains_reader_sections(self):
        ...
        self.assertIn("Published not available", html)
    ...
    def test_article_prompt_uses_chinese_reading_note_format(self):
        ...
        self.assertIn("Published: 2026-01-01T15:30:00+00:00", prompt)
